...
import com.example.mvi.common.loading.LoadingDialog
import com.example.mvi.common.utils.showToast
import com.example.mvi.data.model.state.UiState
import com.example.mvi.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupObserves()
        viewModel.processIntent(LoginIntent.ResetState)
    }
